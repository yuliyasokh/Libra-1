...
<html>
    ...
    <body>
        ...
        <tr>
            ...
            <td>Строка </td>
            <td>Максималная длина ${t.getDescription()} символов</td>
            </c:if>
            <c:if test="${t.getTypeName()=='integer'}">
            <td>Число </td>
            <td>Диапазон:  ${t.getDescription()}</td>
            </c:if>
            <c:if test="${t.getTypeName()=='enum'}">
            <td>Перечислимый тип</td>
            <td>Возможны значения: ${t.getDescription()}</td>
            </c:if>
            <c:if test="${(t.getTypeName()!='enum')&&(t.getTypeName()!='integer')&&(t.getTypeName()!='string')}">
            <td>${t.getTypeName()}</td>
