...
<body>
	<div class="container">
		...
		<form:form commandName = "appForm" method="POST" action="appform2.html" enctype="multipart/form-data">
				...
				<div class="span4">
					...
					<div class="fileupload fileupload-new" data-provides="fileupload">
						...
						<div>
							...
							<input name="photo" type="file"/></span> <a href="#" class="btn fileupload-exists"
